...
import { ForgetPasswordFormData } from "../../../../services/interfaces";
...
const ForgetPassword = () => {
  ...
  const {formState:{errors,isSubmitting} , register , handleSubmit}= useForm<ForgetPasswordFormData>()

  const onSubmitHandler = async (data:ForgetPasswordFormData) => {
